...
//            val shipment = TrackingServer.findShipment(idToTrack) // Calls mock
//            if (shipment != null) {
...
//                    val shipment = TrackingServer.findShipment(idToStopTracking) // Calls mock
